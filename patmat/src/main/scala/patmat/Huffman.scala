...
object Huffman {
  ...
  /**
    ...
    * }
    */
  def times(chars: List[Char]): List[(Char, Int)] = chars.groupBy(k => k).toList.map(t => (t._1, t._2.size))
  ...
  /**
    ...
    */
  def mergeCodeTables(a: CodeTable, b: CodeTable): CodeTable = a.map(t => (t._1, 0 :: t._2)) ::: b.map(t => (t._1, 1 :: t._2))
